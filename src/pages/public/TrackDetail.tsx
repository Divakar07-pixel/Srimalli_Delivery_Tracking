...
export function TrackDetail() {
  ...
  const openInvoice = async (mode: "view" | "download") => {
    try {
      ...
      if (mode === "download") { const a = document.createElement("a"); a.href = url; a.download = ""; a.click(); }
