...
export function TrackDetail() {
  ...
  // Only expose the driver's marker while live tracking is active. The last stored
  // coordinates remain in the database for history, but are never shown as live
  // location after the driver presses Stop Tracking.
