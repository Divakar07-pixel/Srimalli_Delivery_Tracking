...
export interface OrderTrackingDetail {
  order_id: string; tracking_id: string; invoice_number: string; invoice_date: string | null; order_date: string; expected_delivery_date: string | null; status: OrderStatus; grand_total: number; billing_address?: string | null; notes?: string | null; customer_name: string; masked_mobile: string;
